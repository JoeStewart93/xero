...
from app.security import AuthTokenError, decode_access_token, decode_c2_access_token
...
def authenticate_websocket(
    ...
    settings: Settings,
    session: Session,
) -> tuple[RealtimePrincipal, str | None] | None:
    ...
    try:
        ...
        return None
    if user is None or not user.is_enabled or user.username != claims.get("sub"):
        return None
    return RealtimePrincipal(subject=user.username, token_kind="operator"), accepted_protocol
