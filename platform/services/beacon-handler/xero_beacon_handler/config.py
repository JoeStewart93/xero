...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="xero-beacon-handler", alias="HANDLER_SERVICE_NAME")
    service_role: str = "beacon-handler"
    ...
    worker_capacity: int = Field(default=1000, ge=1, alias="WORKER_CAPACITY")
