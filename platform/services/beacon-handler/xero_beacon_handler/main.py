...
from xero_beacon_handler.config import Settings, get_settings

CAPABILITIES = ["reverse-handler", "beacon-connection", "heartbeat"]
WORKER_KIND = "beacon-handler"
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="Xero Beacon Handler API", version="0.1.0", lifespan=lifespan)
