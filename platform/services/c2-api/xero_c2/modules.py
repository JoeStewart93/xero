...
PORTSCAN_ARGS_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "scan_engine": {"type": "string", "enum": ["nmap"], "default": "nmap"},
        "scan_technique": {"type": "string", "enum": ["tcp-connect", "syn", "udp"], "default": "tcp-connect"},
        "timing_template": {"type": "integer", "minimum": 0, "maximum": 5, "default": 3},
        "service_detection": {"type": "boolean", "default": False},
        "os_detection": {"type": "boolean", "default": False},
        "script_scan_enabled": {"type": "boolean", "default": False},
        "script_categories": {
            "type": "array",
            "items": {
                "type": "string",
            ...
            "default": [],
            "description": "Selected NMAP NSE script categories. Disruptive categories require explicit opt-in.",
        },
        "allow_disruptive_scripts": {"type": "boolean", "default": False},
        "dns_resolution": {"type": "boolean", "default": False},
        "execution_target": {
            "type": "string",
            "default": "auto",
            "description": "auto, distributed, or scanner:<worker-id>.",
        },
    },
}
...
BUILTIN_MODULES: list[ModuleDefinition] = [
    ...
    ModuleDefinition(
        ...
        name="NMAP Port Scan",
        category="scanning",
        description="Run an embedded C2 NMAP port scan against authorized lab targets.",
        execution_kind="scan-job",
        supported_execution_targets=["auto", "distributed", "scanner"],
        required_capabilities=["nmap", "tcp-connect", "nse"],
        tags=["recon", "nmap", "tcp", "nse", "scan-job"],
